 ...
 */
public class Haber extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_haber, container, false);
                ...
                try {
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            url1.setText(Urls_subject[34]);
                            url2.setText(Urls_subject[35]);
                            url3.setText(Urls_subject[36]);
                            ...
                            b1.setOnClickListener(new View.OnClickListener()
                            {
                                ...
                                {
                                    String url = ""+Urls[34]; Intent i = new Intent(Intent.ACTION_VIEW); i.setData(Uri.parse(url)); startActivity(i);
                                }
                            });
                            b2.setOnClickListener(new View.OnClickListener()
                            {
                                ...
                                public void onClick(View v)
                                {
                                    String url = ""+Urls[35]; Intent i = new Intent(Intent.ACTION_VIEW); i.setData(Uri.parse(url)); startActivity(i);
                                }
                            });
                            b3.setOnClickListener(new View.OnClickListener()
                            {
                                ...
                                public void onClick(View v)
                                {
                                    String url = ""+Urls[36]; Intent i = new Intent(Intent.ACTION_VIEW); i.setData(Uri.parse(url)); startActivity(i);
                                }
                            });
